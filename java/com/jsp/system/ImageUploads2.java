      ...
      while (true)
         try {
            ...
            try (DBConnector con = new DBConnector();) {
               ...
               int boardListNum2 = map.getNewlyInsertedBoardId2();

               
               System.out.println("이미지가 가져오는 게시글 넘버 : " + boardListNum2);
               System.out.println(imageName);
               
                map.saveImage2(String.join("/", req.getParameter("year"), req.getParameter("month"), req.getParameter("day"),imageName +token), boardListNum2);
